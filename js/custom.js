...
/* Tip Calculator js end */

/* Kilometer to meter js start */
function getselect(){
...
function searchToggle(obj, evt){
    ...
    if(mName == ""){
        document.getElementById("movieApi").style.padding = "80px 80px 103px";
        document.getElementById("allMovieDetail").removeAttribute("class")
    }
    else{
        document.getElementById("movieApi").style.paddingBottom = "80px";
